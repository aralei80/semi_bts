...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="container">
              <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 text-center">
                  <h1>Welcome to <span class="text-primary">BUSAN.</span>  </h1>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row  mb-5">
          <div class="col-md-7">
            <h2 class="heading-39291">여행정보</h2>
        ...
        <div class="row align-items-stretch">
          <div class="col-lg-3 col-md-6 mb-5">
            <div class="post-entry-1 h-100">
              <a href="#">
                <img src="../images/img_s_1.JPG" alt="Image"
                 class="img-fluid">
              </a>
          ...
          <div class="col-lg-3 col-md-6 mb-5">
            <div class="post-entry-1 h-100">
              <a href="#">
                <img src="../images/img_s_2.JPG" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                <span class="meta">July 17, 2019</span>
          ...
          <div class="col-lg-3 col-md-6 mb-5">
            <div class="post-entry-1 h-100">
              <a href="#">
                <img src="../images/img_s_3.JPG" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                <span class="meta">July 17, 2019</span>
          ...
          <div class="col-lg-3 col-md-6 mb-5">
            <div class="post-entry-1 h-100">
              <a href="#">
                <img src="../images/img_s_4.JPG" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                <span class="meta">July 17, 2019</span>
...
<div class="site-section">
      <div class="container">
        <div class="row  mb-5">
          <div class="col-md-7">
         <h2 class="heading-39291">커뮤니티</h2>
         <ul>
         <li></li>
         <hr>
         <li></li>
